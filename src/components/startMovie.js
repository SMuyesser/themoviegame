	    ...
	    return (
			<div className="row">
				<div className="col-lg-6">
					<form className="input-group" onSubmit={e => this.selectStartMovie(e)}>
						<span className="input-group-btn">
							<input className="start-movie-btn" type="submit" value="Starting Movie"/>
						</span>
						<input type="text" className="form-control" placeholder="Find Starting Movie..." ref={input => this.input = input}></input>
					</form>
				</div>
			</div>
	    );
